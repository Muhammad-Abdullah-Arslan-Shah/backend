...
const sportsArray = [
  {
    ...
    logoUrl: "http://localhost:5000/photos/football.jpg",
    name: "football",
  ...
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Basketball.jpg",
    name: "basketball",
    handleDirectResult: false,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Baseball.jpg",
    name: "baseball",
    handleDirectResult: false,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "HOCKEY",
    logoUrl: "http://localhost:5000/photos/Hockey.jpg",
    name: "hockey",
  ...
  {
    displayName: "TENNIS",
    logoUrl: "http://localhost:5000/photos/Tennis.jpg",
    name: "tennis",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/American Football.jpg",
  ...
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Aussie Rules.jpg",
    name: "aussie-rules",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/badminton_cleanup.jpg",
    name: "badminton",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "BOXING",
    logoUrl: "http://localhost:5000/photos/Boxing.jpg",
    name: "boxing",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "CRICKET",
    logoUrl: "http://localhost:5000/photos/Cricket.jpg",
    name: "cricket",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "DARTS",
    logoUrl: "http://localhost:5000/photos/Darts.jpg",
    name: "darts",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "ESPORTS",
    logoUrl: "http://localhost:5000/photos/esports.jpg",
    name: "esports",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "FUTSAL",
    logoUrl: "http://localhost:5000/photos/Futsal.jpg",
    name: "futsal",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Handball.jpg",
    name: "handball",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  ...
  {
    displayName: "MMA",
    logoUrl: "http://localhost:5000/photos/MMA.jpg",
    name: "mma",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Rugby League.jpg",
    name: "rugby-league",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Rugby Union.jpg",
    name: "rugby-union",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/table tennis.jpg",
    name: "table-tennis",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Volleyball.jpg",
    name: "volleyball",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
  },
  {
    ...
    logoUrl: "http://localhost:5000/photos/Water Polo.jpg",
    name: "water-polo",
    handleDirectResult: true,
    partialSum: 2,
    enabled: true,
